        ...
        [this]
        {
            m_drive.Drive(
                -units::meters_per_second_t{frc::ApplyDeadband(
                    std::pow(m_driverController.GetX(), 3), OIConstants::kDriveDeadband,
                    DriveConstants::kTargetSpeed.value())},
                -units::meters_per_second_t{frc::ApplyDeadband(
                    std::pow(m_driverController.GetY(), 3), OIConstants::kDriveDeadband,
                    DriveConstants::kTargetSpeed.value())},
                -units::radians_per_second_t{frc::ApplyDeadband(
                    std::pow(m_driverController.GetZ(), 3), OIConstants::kDriveDeadband,
