  ...
  ShooterSubsystem()
      : m_top(ShooterConstants::kTopShooterCanId,
        ...
        m_bottom(ShooterConstants::kBottomShooterCanId,
                 rev::spark::SparkMax::MotorType::kBrushless)
  {
    m_top.Configure(Configs::MAXSwerveModule::OneConversionConfig(), // TODO: Configure this properly
                    rev::spark::SparkBase::ResetMode::kResetSafeParameters,
                    rev::spark::SparkBase::PersistMode::kPersistParameters);

    m_bottom.Configure(Configs::MAXSwerveModule::OneConversionConfig(),
                       rev::spark::SparkBase::ResetMode::kResetSafeParameters,
                       rev::spark::SparkBase::PersistMode::kPersistParameters);
    Stop();
  }
